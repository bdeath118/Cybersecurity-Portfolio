...
interface BugBountyManagerProps {
  initialBugBountyPrograms: BugBountyProgram[]
}

export function BugBountyManager({ initialBugBountyPrograms }: BugBountyManagerProps) {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Manage Bug Bounty Programs</CardTitle>
      </CardHeader>
      <CardContent>
              ...
              <Card key={program.id} className="p-4">
                {editingProgram?.id === program.id ? (
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-gray-500">{program.platform}</p>
                    <div className="flex justify-end gap-2">
